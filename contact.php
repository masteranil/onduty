...
<html>
    ...
    <body>
        <?php require 'utils/indexheader.php'; ?><!--header content. file found in utils folder-->
        <div class = "content"><!--body content holder-->
            ...
            <div class="container">
                <div class="col-md-6 contacts">
                    <h1><span class="glyphicon glyphicon-user"></span> ADMIN</h1>
                    <p>
                        <span class="glyphicon glyphicon-envelope"></span> Email: admin@sonatech.ac.in<br>
