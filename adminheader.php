    ...
    <nav class="navbar" style="background:black !important;">
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right"><!--navigation-->
                ...
                {
                    echo '<li><a href = " adminviewstudents.php  ">Applied students</a></li>';
                    echo '<li><a href = "studentregister_form.php">Add new student</a></li>';
                    echo '<li><a href = "register_form.php">Add new organizer</a></li>';   
