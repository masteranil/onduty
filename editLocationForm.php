...
<html>
    ...
    <body>
        ...
        <div class="content">
            <div class="container">
                <h1>Edit Organizer Form</h1><!--form title-->
                <?php 
                ...
                <form action="editLocation.php" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="Name" class="col-md-2 control-label">Event Name</label><!--label-->
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label for="Address" class="col-md-2 control-label">Venue</label><!--label-->
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label for="ManagerFName" class="col-md-2 control-label">Organizer Name</label><!--label-->
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label for="ManagerEmail" class="col-md-2 control-label">Organizer Email</label><!--label-->
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label for="ManagerNumber" class="col-md-2 control-label">Organizer Number</label><!--label-->
                        <div class="col-md-5">
