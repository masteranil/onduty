...
require_once 'classes/studenttable.php';
...
try {
    ...
    if (empty($errors)) {
        ...
        // create a studenttable object and use it to retrieve 
        // the users
        $connection = DB::getConnection();
        $usertable = new studenttable($connection);
    ...
    // studenttable object, and store it in the session array
    // using the key 'user'
    $_SESSION['user'] = $user;
